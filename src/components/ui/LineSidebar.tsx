...
export default function LineSidebar({
  ...
  const currentActiveIndex = active !== undefined ? active : internalActive;
      ...
      >
        {items.map((label, index) => (
          <li
            ...
            aria-current={currentActiveIndex === index ? "true" : undefined}
            onClick={() => handleClick(index, label)}
          >
            {showMarker && (
              <span className="line-sidebar__marker" aria-hidden="true" />
            )}
            <span className="line-sidebar__label font-valley">
              {showIndex && (
